...
public class IntegerError extends FlightData {

	private static HashMap<String, Integer> vouchers = new HashMap<String, Integer>();

	public IntegerError(String flightCode, String departureTime, String arrivalTime, int duration, int cost) {
	...
	public static void main(String[] args) {
		...
		SimpleDirectedWeightedGraph<String, FlightData> airport = new SimpleDirectedWeightedGraph<String, FlightData>(
				FlightData.class);
		...
		String[] vertices = { "Edinburgh", "Heathrow", "Amsterdam", "Boston", "Chicago", "Montreal", "Toronto",
	...
	public static void createItinerary(Graph<String, FlightData> airport, String departure, String destination) {
		...
		int hours = Integer.parseInt(Double.toString(totalTime).substring(0, 2));
		int minutes = Integer.parseInt(Double.toString(totalTime).substring(2, 4));
		...
		if (returnJourney.equalsIgnoreCase("yes")) {
			...
			// iterate through the path and print flight data of current flight
			// in
			// path. Calculate total cost and time.
	...
	// create a method to reset the minutes once it has reached an hour
